...
25) Minden táblához csináljuk egy-egy struktúrát/class-t ami képes egy sort tárolni (egy táblabeli sort).
    Ez kb azt jelenti, hogy a modell attribútumai/tábla oszlopai lesznek a class memberjei/property-ei.

26) Alakítsuk át a SELECT -es fgv-eket, hogy listákat adjanak vissza.
